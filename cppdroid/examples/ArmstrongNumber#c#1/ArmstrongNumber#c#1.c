...
Résumé: Vérifiez si un nombre est armstrong ou non. Un nombre est Armstrong si la somme des cubes de chiffres individuels d'un nombre est égal au nombre lui-même. Par exemple 371 est un nombre Armstrong + 343 + 27 = 371 1.
*/
