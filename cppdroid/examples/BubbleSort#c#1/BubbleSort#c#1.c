...
Complexity - O(n^2)
Résumé: Bubble tri est un algorithme de tri simple qui fonctionne en intensifiant plusieurs reprises dans la liste pour être triés, en comparant chaque paire d'éléments adjacents et les échanger si elles sont dans le mauvais ordre.
Complexité - O (n ^ 2)
*/
