/*
Résumé : tri alphabétique est un programme par lequel des chaînes de caractères sont placés dans l'ordre sur la base de la position des personnages dans l'ordonnancement classique d'un alphabet.
